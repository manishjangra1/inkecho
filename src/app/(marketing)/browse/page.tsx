    ...
    <div className="py-12">
      <Container size="lg">
        <PageHeader
          ...
          badge={
            <span className="hidden items-center gap-1.5 rounded-full border border-brand-primary/20 bg-brand-primary/10 px-3 py-1 text-xs font-semibold text-brand-primary">
