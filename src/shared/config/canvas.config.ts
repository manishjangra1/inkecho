export const CANVAS_CONFIG = {
  ...
  BRUSH: {
    ...
    PALETTE: [
      { id: 'brush-1', name: 'Black', hex: '#000000' },
      { id: 'brush-2', name: 'Red', hex: '#EF4444' },
      { id: 'brush-3', name: 'Orange', hex: '#F97316' },
      { id: 'brush-4', name: 'Yellow', hex: '#EAB308' },
      { id: 'brush-5', name: 'Green', hex: '#22C55E' },
      { id: 'brush-6', name: 'Blue', hex: '#3B82F6' },
      { id: 'brush-7', name: 'Purple', hex: '#A855F7' },
      { id: 'brush-8', name: 'White', hex: '#FFFFFF' },
    ] as const,
  },
  UNDO_REDO: {
    MIN_STACK_DEPTH: 20,
